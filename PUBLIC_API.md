...
- The runner-neutral subagent contract, host-resolution helpers, optional empty-by-default backend registry, and `PiSdkIsolatedBackend` adapter are 0.4 experimental surfaces.
