import type { PromptRegexRule, PromptResourcePolicy, PromptStack, PromptStackDiagnostic, PromptStackItem } from "../../types.ts";
import type { WebEditorPayloadSnapshot, WebEditorPolicyResource, WebEditorStackSummary } from "../types.ts";
