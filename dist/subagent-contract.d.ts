...
import { type AgentProfile, type AgentProfileModelReference } from "./agent-profile.ts";
...
export declare function validateAgentRequest(value: unknown): SubagentDiagnostic[];
export declare function validateAgentProfileSnapshot(value: unknown): SubagentDiagnostic[];
...
export declare function hasSubagentErrors(diagnostics: readonly SubagentDiagnostic[]): boolean;
//# sourceMappingURL=subagent-contract.d.ts.map