...
export declare function armPayloadIntercept(state: PiForgeRuntimeState, ctx: ExtensionContext, savePath?: string, displayTarget?: PayloadDisplayTarget): void;
export declare function clearPayloadCapture(state: PiForgeRuntimeState, ctx: ExtensionContext): void;
