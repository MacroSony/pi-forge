...
const en = {
	...
	"nav.stackSectionsAria": "Stack editor sections",
	"chrome.toggleSidebar": "Toggle prompt stacks sidebar",
	"chrome.brand": "pi-forge stack editor",
	"chrome.loading": "Loading",
	"chrome.unsaved": "Unsaved",
	"chrome.unsavedTitle": "The current stack has unsaved edits",
	"chrome.reload": "Reload",
	"chrome.reloadTitle": "Reload prompt stacks from disk",
	"chrome.disableStack": "Disable stack",
	"chrome.disableStackTitle": "Disable the active prompt stack",
	"chrome.scopeTitle": "Scope for new stacks, imports, and forks",
	"chrome.scopeAria": "Stack scope",
	"chrome.scopeProject": "Project",
	"chrome.scopeGlobal": "Global",
	"chrome.newStack": "New stack",
	"chrome.newStackTitle": "Create a new prompt stack (Ctrl/Cmd+N)",
	"chrome.activate": "Activate",
	"chrome.activateTitle": "Make this stack active for the current Pi session",
	"chrome.save": "Save",
	"chrome.saveTitle": "Save the edited stack JSON to disk (Ctrl/Cmd+S)",
	"chrome.validate": "Validate",
	"chrome.validateTitle": "Validate the edited stack without saving (Ctrl/Cmd+Shift+Enter)",
	"chrome.preview": "Preview",
	"chrome.previewTitle": "Preview the compiled prompt without sending it (Ctrl/Cmd+Enter)",
	"chrome.more": "More",
	"chrome.moreTitle": "Show less-used stack actions",
	"chrome.armPayload": "Arm payload",
	"chrome.armPayloadTitle": "Capture the next provider payload in the browser",
	"chrome.fork": "Fork",
	"chrome.forkTitle": "Create a new stack from the current edits",
	"chrome.import": "Import JSON",
	"chrome.importTitle": "Import pi-forge stack JSON",
	"chrome.export": "Export JSON",
	"chrome.exportTitle": "Download the current stack JSON, or copy it if download is unavailable",
	"chrome.deleteStack": "Delete stack",
	"chrome.deleteStackTitle": "Delete the selected stack JSON file",
	"chrome.items": "Items",
	...
	"status.appliedStack": "Applied stack JSON to editor",
	...
	"status.stackDisabled": "Prompt stack disabled",
	"status.deleted": "Deleted {id}",
	"status.deletedNoneRemain": "Deleted {id}; no stacks remain",
	"status.reloaded": "Reloaded from disk",
	"status.noStacks": "No prompt stacks found",
	"status.sidebarHidden": "Prompt stacks sidebar hidden",
	"status.sidebarShown": "Prompt stacks sidebar shown",
	"stackList.empty": "No prompt stacks in this project.",
	...
	"confirm.useStackId": "Use stack id '{id}'?",
	"confirm.activateNewStack": "Activate new stack now?",
	"confirm.activateImportedStack": "Activate imported stack now?",
	"confirm.activateFork": "Activate fork now?",
	"confirm.deleteStack": "Delete prompt stack '{id}'?\n\nThis removes its JSON file from prompt-stack storage.",
	"prompt.newStackId": "New stack id",
	"prompt.stackId": "Stack id",
	"prompt.stackDisplayName": "Stack display name",
	"prompt.forkStackId": "New fork stack id",
	"prompt.forkDisplayName": "Fork display name",
	"error.stackIdEmpty": "Stack id must not be empty.",
	"error.importNotObject": "Imported JSON must be an object.",
	"error.importNoItems": "Imported stack must contain an items array.",
	"error.noStackSelected": "No stack selected.",
	...
	"empty.title": "No prompt stacks found.",
	"empty.body": "Create a stack in this project, or import an existing pi-forge JSON file.",
	"chrome.showSidebar": "Show prompt stacks sidebar",
	"chrome.hideSidebar": "Hide prompt stacks sidebar",
	"inspector.validationComplete": "Validation complete",
	"inspector.previewRendered": "Preview rendered",
	...
	"inspector.previewAria": "Prompt preview",
	"inspector.plainTextFallback": "Plain text fallback",
	"inspector.copy": "Copy",
	"inspector.copyFullTitle": "Copy the full preview text",
	"inspector.closePreview": "Close the preview",
	"inspector.sectionMeta": "{chars} chars · ~{tokens} tokens",
	"inspector.copySectionTitle": "Copy this preview section",
	"inspector.previewTitleId": "Prompt preview: {id}",
	"inspector.previewMeta": "{chars} chars · ~{tokens} tokens · {count} messages",
	"inspector.copyFull": "Copy full",
	"inspector.copyFullPromptTitle": "Copy the full prompt preview",
	...
	"status.metadataHidden": "Stack metadata hidden",
	"status.metadataShown": "Stack metadata shown",
	"metadata.toggleTitle": "Show or hide stack metadata",
	"metadata.title": "Metadata",
	"metadata.noId": "(no id)",
	"metadata.stackId": "Stack ID",
	"metadata.stackIdTitle": "Stack IDs are immutable; use Fork to create a new ID.",
	"metadata.name": "Name",
	"metadata.mode": "Mode",
	...
	"stackTab.contextMeta": "Stack-level behavior for how pi-forge rewrites Pi conversation context.",
	...
	"stackTab.parameters": "Stack parameters",
	...
	"stackTab.addVariable": "Add variable",
	"stackTab.addVariableTitle": "Add a static stack variable",
	...
	"stackTab.deleteVariableTitle": "Delete this stack variable",
	"stackTab.stackJson": "Stack JSON",
	...
	"stackTab.rawDraft": "Unsaved stack JSON draft.",
	"stackTab.duplicateVarNames": "Duplicate stack variable names.",
	"stackTab.copiedJson": "Copied JSON.",
	"stackTab.copiedJsonStatus": "Copied stack JSON",
	"stackTab.appliedJson": "Applied stack JSON to editor.",
	"error.stackJsonNotObject": "Stack JSON must be an object.",
	"error.stackJsonNoId": "Stack JSON needs a non-empty string id.",
	"error.stackJsonNoItems": "Stack JSON needs an items array.",
	...
	"regex.validateTitle": "Validate the edited stack",
	...
	"common.none": "(none)",
	"profiles.subheading": "One-shot model, thinking, and prompt-stack presets. Applying a profile does not continuously own runtime state.",
	...
	"profiles.promptStack": "Prompt stack",
	"profiles.effectiveTools": "Effective tools after stack policy",
	...
	"profiles.driftStack": "Stack: {label}",
	...
	"profileEditor.globalStackHint": "Global profiles may only reference user-global prompt stacks. A same-scope stack may be stored as a relative bare ID without changing its global resolution.",
	"profileEditor.projectStackHint": "Project profiles may reference project stacks or explicitly qualified global stacks.",
	...
	"diff.selectStackHint": "Select a stack to see its compiled prompt.",
	"diff.selectStackToPreview": "Select a stack to preview.",
	...
	"diff.draftEmpty": "Select a saved stack to compare its current draft with disk.",
...
const zhCN: Record<MessageKey, string> = {
	...
	"nav.stackSectionsAria": "堆栈编辑器区域",
	"chrome.toggleSidebar": "切换提示词堆栈侧栏",
	"chrome.brand": "pi-forge 堆栈编辑器",
	"chrome.loading": "加载中",
	"chrome.unsaved": "未保存",
	"chrome.unsavedTitle": "当前堆栈有未保存的修改",
	"chrome.reload": "重新加载",
	"chrome.reloadTitle": "从磁盘重新加载提示词堆栈",
	"chrome.disableStack": "停用堆栈",
	"chrome.disableStackTitle": "停用当前激活的提示词堆栈",
	"chrome.scopeTitle": "新建堆栈、导入和派生的目标作用域",
	"chrome.scopeAria": "堆栈作用域",
	"chrome.scopeProject": "项目",
	"chrome.scopeGlobal": "全局",
	"chrome.newStack": "新建堆栈",
	"chrome.newStackTitle": "创建新的提示词堆栈（Ctrl/Cmd+N）",
	"chrome.activate": "激活",
	"chrome.activateTitle": "将此堆栈设为当前 Pi 会话的激活堆栈",
	"chrome.save": "保存",
	"chrome.saveTitle": "将编辑后的堆栈 JSON 保存到磁盘（Ctrl/Cmd+S）",
	"chrome.validate": "校验",
	"chrome.validateTitle": "校验编辑中的堆栈但不保存（Ctrl/Cmd+Shift+Enter）",
	"chrome.preview": "预览",
	"chrome.previewTitle": "预览编译后的提示词，不发送（Ctrl/Cmd+Enter）",
	"chrome.more": "更多",
	"chrome.moreTitle": "显示不常用的堆栈操作",
	"chrome.armPayload": "捕获载荷",
	"chrome.armPayloadTitle": "在浏览器中捕获下一次 provider 载荷",
	"chrome.fork": "派生",
	"chrome.forkTitle": "基于当前编辑内容创建新堆栈",
	"chrome.import": "导入 JSON",
	"chrome.importTitle": "导入 pi-forge 堆栈 JSON",
	"chrome.export": "导出 JSON",
	"chrome.exportTitle": "下载当前堆栈 JSON；无法下载时复制到剪贴板",
	"chrome.deleteStack": "删除堆栈",
	"chrome.deleteStackTitle": "删除所选堆栈的 JSON 文件",
	"chrome.items": "条目",
	"chrome.addBlock": "添加块",
	...
	"status.appliedStack": "已将堆栈 JSON 应用到编辑器",
	"status.saved": "已保存 {id}",
	...
	"status.stackDisabled": "提示词堆栈已停用",
	"status.deleted": "已删除 {id}",
	"status.deletedNoneRemain": "已删除 {id}；没有剩余堆栈",
	"status.reloaded": "已从磁盘重新加载",
	"status.noStacks": "未找到提示词堆栈",
	"status.sidebarHidden": "提示词堆栈侧栏已隐藏",
	"status.sidebarShown": "提示词堆栈侧栏已显示",
	"stackList.empty": "此项目中没有提示词堆栈。",
	"stackList.active": "当前",
	"stackList.global": "全局",
	...
	"confirm.overwriteStack": "{message}\n\n要覆盖它吗？",
	"confirm.useStackId": "使用堆栈 id“{id}”？",
	"confirm.activateNewStack": "立即激活新堆栈？",
	"confirm.activateImportedStack": "立即激活导入的堆栈？",
	"confirm.activateFork": "立即激活派生的堆栈？",
	"confirm.deleteStack": "删除提示词堆栈“{id}”？\n\n这将从堆栈存储中删除其 JSON 文件。",
	"prompt.newStackId": "新堆栈 id",
	"prompt.stackId": "堆栈 id",
	"prompt.stackDisplayName": "堆栈显示名称",
	"prompt.forkStackId": "新派生堆栈 id",
	"prompt.forkDisplayName": "派生堆栈显示名称",
	"error.stackIdEmpty": "堆栈 id 不能为空。",
	"error.importNotObject": "导入的 JSON 必须是对象。",
	"error.importNoItems": "导入的堆栈必须包含 items 数组。",
	"error.noStackSelected": "未选择堆栈。",
	...
	"diag.toggle": "切换诊断面板",
	"empty.title": "未找到提示词堆栈。",
	"empty.body": "在此项目中创建堆栈，或导入现有的 pi-forge JSON 文件。",
	"chrome.showSidebar": "显示提示词堆栈侧栏",
	"chrome.hideSidebar": "隐藏提示词堆栈侧栏",
	"inspector.validationComplete": "校验完成",
	"inspector.previewRendered": "预览已渲染",
	...
	"inspector.previewAria": "提示词预览",
	"inspector.plainTextFallback": "纯文本回退",
	"inspector.copy": "复制",
	"inspector.copyFullTitle": "复制完整预览文本",
	"inspector.closePreview": "关闭预览",
	"inspector.sectionMeta": "{chars} 字符 · 约 {tokens} token",
	"inspector.copySectionTitle": "复制此预览片段",
	"inspector.previewTitleId": "提示词预览：{id}",
	"inspector.previewMeta": "{chars} 字符 · 约 {tokens} token · {count} 条消息",
	"inspector.copyFull": "全部复制",
	"inspector.copyFullPromptTitle": "复制完整提示词预览",
	...
	"status.metadataHidden": "堆栈元数据已隐藏",
	"status.metadataShown": "堆栈元数据已显示",
	"metadata.toggleTitle": "显示或隐藏堆栈元数据",
	"metadata.title": "元数据",
	"metadata.noId": "（无 id）",
	"metadata.stackId": "堆栈 ID",
	"metadata.stackIdTitle": "堆栈 ID 不可变；请使用“派生”创建新 ID。",
	"metadata.name": "名称",
	"metadata.mode": "模式",
	...
	"stackTab.contextMeta": "pi-forge 改写 Pi 会话上下文的堆栈级行为。",
	...
	"stackTab.mergeTitle": "将连续的同角色堆栈条目合并为一条消息。聊天历史和 custom 角色条目永远不会被合并。",
	"stackTab.merge": "合并连续同角色条目",
	"stackTab.mergeNote": "仅合并堆栈编写的 user/assistant 条目；聊天历史和 custom 角色条目是硬边界。",
	...
	"stackTab.rawDraft": "未保存的堆栈 JSON 草稿。",
	"stackTab.duplicateVarNames": "堆栈变量名重复。",
	"stackTab.copiedJson": "已复制 JSON。",
	"stackTab.copiedJsonStatus": "已复制堆栈 JSON",
	"stackTab.appliedJson": "已将堆栈 JSON 应用到编辑器。",
	"error.stackJsonNotObject": "堆栈 JSON 必须是对象。",
	"error.stackJsonNoId": "堆栈 JSON 需要非空字符串 id。",
	"error.stackJsonNoItems": "堆栈 JSON 需要 items 数组。",
	...
	"common.delete": "删除",
	"common.none": "（无）",
	"profiles.subheading": "一次性的模型、思考级别与提示词堆栈预设。应用配置不会持续持有运行时状态。",
	...
	"profiles.promptStack": "提示词堆栈",
	"profiles.effectiveTools": "堆栈策略后的有效工具",
	...
	"profileEditor.globalStackHint": "全局配置只能引用用户全局提示词堆栈。同作用域堆栈可以存为相对裸 ID，不影响其全局解析。",
	"profileEditor.projectStackHint": "项目配置可以引用项目堆栈或显式限定的全局堆栈。",
	...
	"diff.selectStackHint": "选择一个堆栈以查看其编译后的提示词。",
	"diff.selectStackToPreview": "选择一个堆栈以预览。",
	...
	"diff.draftEmpty": "选择一个已保存的堆栈，将其当前草稿与磁盘版本对比。",
