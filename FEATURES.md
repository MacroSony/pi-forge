...
- Supported runtime baseline is Node.js 22.19+ with the exact `@earendil-works/pi-*` 0.80.10 package set; other 0.80.x SDK versions are not claimed as compatible.
